package com.tritiumstudios.phasmophobiaevidencetool.firebase.firestore.transactions.user.account;

import android.util.Log;

import androidx.annotation.NonNull;

import com.tritiumstudios.phasmophobiaevidencetool.firebase.firestore.transactions.user.FirestoreAccount;
