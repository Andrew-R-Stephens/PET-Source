package com.tritiumstudios.phasmophobiaevidencetool.data.controllers.theming.subsets;
...
import com.tritiumstudios.phasmophobiaevidencetool.data.controllers.theming.AThemeControl;
 ...
 */
public class FontThemeControl extends AThemeControl {

    public FontThemeControl(Context context) {
        super(context);

        defaultStyle = R.style.Fonts_Base;
    }
