...
public class PossessionDataView extends ItemStoreDataView {

    public PossessionDataView(@NonNull Context context) {
        super(context);
        init(context);
    }

    public PossessionDataView(@NonNull Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
        init(context);
    }

    public PossessionDataView(@NonNull Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
        init(context);
    }

    public PossessionDataView(@NonNull Context context, @Nullable AttributeSet attrs, int defStyleAttr, int defStyleRes) {
    ...
    public void init(Context context) {
        super.init();
        layoutResId = R.layout.layout_itemstore_itemdata_possessions;
    ...
    public void buildData(ItemStoreViewModel itemStoreViewModel, int groupIndex, int itemIndex) {
        ...
        ItemStoreComposablesKt.setPossessionSimple(itemImageView, itemData.getImageData() );
    }
}
