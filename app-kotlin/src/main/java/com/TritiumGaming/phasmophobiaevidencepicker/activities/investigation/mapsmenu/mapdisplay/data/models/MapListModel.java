...
public class MapListModel {
    ...
    public MapListModel(@NonNull WorldMapWrapper worldMapWrapper) {
        try {
    ...
    public void parseMinified(@NonNull WorldMapWrapper worldMapWrapper) {
    ...
    public void parseUnMinified(@NonNull WorldMapWrapper worldMapWrapper) {
        mapModels = new ArrayList<>();
