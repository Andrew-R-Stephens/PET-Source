...
import com.tritiumgaming.phasmophobiaevidencepicker.presentation.ui.activities.impl.SignInCredentialManager.SignInOptions.GOOGLE
import com.tritiumgaming.phasmophobiaevidencepicker.presentation.ui.activities.impl.SignInCredentialManager.SignInOptions.ID_FALLBACK
import com.tritiumgaming.phasmophobiaevidencepicker.presentation.ui.activities.impl.SignInCredentialManager.SignInOptions.ID_SILENT
import com.tritiumgaming.phasmophobiaevidencepicker.presentation.ui.activities.impl.SignInCredentialManager.SignInOptions.ID_UI
import com.tritiumgaming.phasmophobiaevidencepicker.presentation.ui.activities.impl.SignInCredentialManager.SignInOptions.SILENT
...
interface SignInCredentialManager {
    ...
    private fun signInWithGoogleIDOptionSilentWithFallback(
        ...
        try {
            ...
            Log.e("FirebaseAuth", "Silent ID sign in failed. Credential does not exist.")
    ...
    fun SignInCredentialManager.createUserDocument(
        onSuccess: () -> Unit = {},
        onFailure: () -> Unit = {},
        onComplete: () -> Unit = {}
    ) {
