package com.tritiumgaming.shared.operation.domain.evidence.mapper
...
class EvidenceResources {
    ...
    enum class EvidenceTierDescription {
        DOTS_1,
        DOTS_2,
        DOTS_3,
        EMF_5_1,
    ...
    enum class EvidenceTierRequiredLevel {
        DOTS_1,
        DOTS_2,
        DOTS_3,
        EMF_5_1,
