...
class UpdateInvestigationDifficultyUseCase(private val repository: InvestigationRepository) {
    operator fun invoke(difficulty: DifficultyData) = repository.updateDifficulty(difficulty)
}
