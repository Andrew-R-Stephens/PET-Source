package com.tritiumstudios.phasmophobiaevidencetool.android.activities.investigation.utilities.codex.views;
...
public class CodexGridCard extends MaterialCardView {
    ...
    public CodexGridCard(@NonNull Context context) {
        super(context);
        initView(context);
    }

    public CodexGridCard(@NonNull Context context, AttributeSet attrs) {
        super(context, attrs);
        initView(context, attrs);
    }

    public CodexGridCard(@NonNull Context context, AttributeSet attrs, int defStyleAttr) {
