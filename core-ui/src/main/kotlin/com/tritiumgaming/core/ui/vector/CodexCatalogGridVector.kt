...
fun getCodexCatalogGridVector(colors: IconVectorColors = IconVectorColors.defaults()): ImageVector =
    Builder(
        name = "CodexCatalogGridVector",
        ...
        group {
            path(
                fill = SolidColor(Color(0xFF161C1C)), stroke =
        ...
        group {
            path(
                fill = SolidColor(Color(0xFFFFFFFF)), stroke =
                    SolidColor(Color(0xFFFFFFFF)), fillAlpha = 0.0f, strokeAlpha = 0.1f,
            ...
            path(
                fill = SolidColor(Color(0xFFFFFFFF)), stroke =
                    SolidColor(Color(0xFFFFFFFF)), fillAlpha = 0.0f, strokeAlpha = 0.08f,
                strokeLineWidth = 2.0f, strokeLineCap = Butt, strokeLineJoin = Miter,
                strokeLineMiter = 4.0f, pathFillType = NonZero
            ) {
                moveTo(51.98f, -0.61f)
            ...
            path(
                fill = SolidColor(Color(0xFFFFFFFF)), stroke =
                    SolidColor(Color(0xFFFFFFFF)), fillAlpha = 0.0f, strokeAlpha = 0.01f,
                strokeLineWidth = 2.0f, strokeLineCap = Butt, strokeLineJoin = Miter,
                strokeLineMiter = 4.0f, pathFillType = NonZero
            ) {
                moveTo(73.98f, -0.61f)
            ...
            path(
                fill = SolidColor(Color(0xFFFFFFFF)), stroke =
                    SolidColor(Color(0xFFFFFFFF)), fillAlpha = 0.0f, strokeAlpha = 0.04f,
                strokeLineWidth = 2.0f, strokeLineCap = Butt, strokeLineJoin = Miter,
                strokeLineMiter = 4.0f, pathFillType = NonZero
            ) {
