...
fun getButtonScratchedVector(colors: IconVectorColors = IconVectorColors.defaults()): ImageVector =
    Builder(
        ...
        path(
            fill = SolidColor(colors.strokeColor), stroke = SolidColor(colors.strokeColor),
            strokeLineWidth = 0.0f, strokeLineCap = Butt, strokeLineJoin = Miter,
            strokeLineMiter = 4.0f, pathFillType = NonZero
        ) {
            moveTo(605.0f, 11.5f)
