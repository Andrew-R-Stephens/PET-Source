package com.TritiumGaming.phasmophobiaevidencepicker.fragments.investigation.maps.map;
...
import com.TritiumGaming.phasmophobiaevidencepicker.views.InteractiveMapControlView;
import com.TritiumGaming.phasmophobiaevidencepicker.views.InteractiveMapDisplayView;
...
public class MapViewerFragment extends Fragment {
    ...
    public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
        ...
        if (mapViewViewModel != null && imageDisplay != null) {
            ...
            if (tempData != null) {
                selectorGroup = new LayerSelectorGroup(tempData.getFloorCount());
     ...
     */
    private class LayerSelectorGroup {

        private final LayerSelector[] selectors;

        /**
         * LayerSelectorGroup constructor
         * @param count - the total number of Selectors, based on map layers
         */
        public LayerSelectorGroup(int count) {
            selectors = new LayerSelector[count];
            for (int i = 0; i < selectors.length; i++)
                selectors[i] = new LayerSelector(getContext());
            if (mapViewViewModel != null)
        ...
        public void deSelectAll() {
            for (LayerSelector selector : selectors)
                if (selector != null)
         ...
         */
        public LayerSelector[] getSelectors() {
            return selectors;
        }
         ...
         */
        private class LayerSelector extends androidx.appcompat.widget.AppCompatImageView {
             ...
             */
            public LayerSelector(Context context) {
                super(context);
