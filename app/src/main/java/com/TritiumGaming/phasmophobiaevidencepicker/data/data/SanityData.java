...
public class SanityData {
     ...
     */
    public void setFlashTimeoutMax(long timeout){
        flashTimeoutMax = timeout;
    }
     ...
     * setProgressManually
     *
     * @param progressOverride
     *
     * Accepts a passed value to specify the progress, either done locally or through views
     * Resets the Warning Indicator to start flashing again, if necessary
     ...
     * tick
     *
     * Reduces player sanity level each tick. Sanity cannot drop below 50% if the clock still has time remaining.
     */
    public void tick(){
