package com.tritiumgaming.phasmophobiaevidencepicker.data.model.reviews
...
class ReviewTrackingRepository(
    ...
    suspend fun loadAll() {
        Log.d("ReviewTracking", "Loading")
        loadWasRequested()
        loadTimeActive()
        loadTimesOpened()
        Log.d("ReviewTracking", "Finalizing Load")
    }

    suspend fun saveAll() {
        Log.d("ReviewTracking", "Saving")
        saveWasRequested()
        saveTimeActive()
        saveTimesOpened()
        Log.d("ReviewTracking", "Finalizing Save")
    }
