    ...
    data class GhostScore(
        ...
        fun getEvidenceScore(
            ...
            difficultyCarouselModel: DifficultyCarouselModel?): Int {
                ...
                val isNightmare = currentDifficulty == DifficultyTitle.NIGHTMARE
                val isInsanity = currentDifficulty == DifficultyTitle.INSANITY
                ...
                for (e in ghostModel.strictEvidenceList) {
                    if (e?.ruling == Ruling.NEGATIVE) { return -8 }
                }
