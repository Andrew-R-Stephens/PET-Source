...
import com.TritiumGaming.phasmophobiaevidencepicker.rendering.model3D.model.Object3D;
...
import com.TritiumGaming.phasmophobiaevidencepicker.rendering.model3D.model.Object3DImpl;
import com.TritiumGaming.phasmophobiaevidencepicker.rendering.model3D.util.GLUtil;
...
public class ModelRendererAlt implements GLSurfaceView.Renderer {

	private final static String TAG = ModelRenderer.class.getName();

	// 3D window (parent component)
	private ModelSurfaceViewAlt main;
	// width of the screen
	private int width;
	// height of the screen
	private int height;
	// Out point of view handler
	private CameraAlt camera;
	 ...
	 *            the 3D window
	 */
	public ModelRendererAlt(ModelSurfaceViewAlt modelSurfaceView) {
	...
	public void onDrawFrame(GL10 unused) {
		...
		SceneLoaderAlt scene = main.getModelActivity().getScene();
		if (scene == null) {
			// scene not ready
			return;
		}
