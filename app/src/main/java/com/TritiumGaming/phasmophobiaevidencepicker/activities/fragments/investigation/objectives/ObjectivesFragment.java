package com.TritiumGaming.phasmophobiaevidencepicker.activities.fragments.investigation.objectives;
...
public class ObjectivesFragment extends Fragment {
    ...
    private ObjectivesSpinner[] objectiveSpinner = null;
    ...
    public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
        ...
        data = new ObjectivesData(view.getContext());
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP) {
            ...
            label_reset.setAutoSizeTextTypeUniformWithConfiguration(5, 20, 1, TypedValue.COMPLEX_UNIT_SP);
        ...
        listener_resetAll.setOnClickListener(v -> {
                    ...
                    ft.detach(ObjectivesFragment.this).commitNow();
                    ft.attach(ObjectivesFragment.this).commitNow();
                }
        );
        ...
        // OBJECTIVE BUTTONS
        ObjectiveCompletedButton[] button_check_evidence = new ObjectiveCompletedButton[]{
        ...
        for (ObjectiveCompletedButton ocb : button_check_evidence) {
            if (ocb != null) {
        ...
        // OBJECTIVE SPINNERS
        objectiveSpinner = new ObjectivesSpinner[]{
                view.findViewById(R.id.objectives_item_1),
                view.findViewById(R.id.objectives_item_2),
                view.findViewById(R.id.objectives_item_3)
        };

        ObjectivesData.Objective[] tempObjectives = objectivesViewModel.getObjectivesSpinnerObjectives();
    ...
    private ObjectivesData.Objective[] findObjectiveSpinnerObjectives(){
        ...
        ObjectivesData.Objective[] temp = new ObjectivesData.Objective[objectiveSpinner.length];
        for(int i = 0; i < objectiveSpinner.length; i++){
