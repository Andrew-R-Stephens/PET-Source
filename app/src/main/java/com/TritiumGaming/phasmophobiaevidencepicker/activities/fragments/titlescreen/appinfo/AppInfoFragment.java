...
public class AppInfoFragment extends Fragment {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        AppCompatTextView developerInfo_title = view.findViewById(R.id.aboutinfo_developerinfo_title);
        AppCompatTextView discordLabel = view.findViewById(R.id.appinfo_joinDiscord);

        LinearLayout linearLayout_developerInfo_subtitles = view.findViewById(R.id.appinfo_developerinfo_subtitles);
        LinearLayout linearLayout_developerInfo_subinfo = view.findViewById(R.id.appinfo_developerinfo_subinfo);

        View appinfo_discordclickbutton = view.findViewById(R.id.appinfo_discordclickbox);

        AppCompatTextView specialThanks_title = view.findViewById(R.id.aboutinfo_specialthanks_title);
        LinearLayout linearLayout_specialThanks = view.findViewById(R.id.scrollview_list_specialthanks);
        ...
        for (int i = 0; i < names.length; i++) {
            ...
            names[i].setTextSize((int) (FontUtils.dpToSp(view, specialThanks_title.getTextSize()) * .9));
