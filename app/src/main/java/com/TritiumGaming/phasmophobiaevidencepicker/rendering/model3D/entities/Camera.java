...
public class Camera {
	...
	public void translateCameraImpl(float dX, float dY) {
		...
		float[] coordinates = new float[] { xPos, yPos, zPos, 1, xView, yView, zView, 1, this.xUp, this.yUp, this.zUp, 1 };
		...
		if (dX != 0 && dY != 0) {
			...
			createRotationMatrixAroundVector(buffer, 24, dX, xUp, yUp, zUp);
		}
		else{
