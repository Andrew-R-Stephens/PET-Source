package com.TritiumGaming.phasmophobiaevidencepicker.rendering.model3D.model;
...
import com.TritiumGaming.phasmophobiaevidencepicker.rendering.model3D.services.WavefrontLoader.Material;
...
import com.TritiumGaming.phasmophobiaevidencepicker.rendering.model3D.services.collada.loader.ColladaLoader;
...
public final class Object3DBuilder {
	...
	static {
		System.setProperty("java.protocol.handler.pkgs", "com.TritiumGaming.phasmophobiaevidencepicker.rendering.util.url|"+System.getProperty("java.protocol.handler.pkgs"));
...
class BoundingBox {
	 ...
	 */
	public BoundingBox(com.TritiumGaming.phasmophobiaevidencepicker.rendering.model3D.entities.BoundingBox box, float[] color) {
		// initialize vertex byte buffer for shape coordinates
	...
	private void calculateVertex(com.TritiumGaming.phasmophobiaevidencepicker.rendering.model3D.entities.BoundingBox box) {
		//@formatter:off
