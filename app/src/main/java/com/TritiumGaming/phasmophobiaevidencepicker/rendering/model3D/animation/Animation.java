package com.TritiumGaming.phasmophobiaevidencepicker.rendering.model3D.animation;


/**
 * 
 * Represents an animation that can applied to an {@link com.TritiumGaming.phasmophobiaevidencepicker.rendering.model3D.model.AnimatedModel} . It
