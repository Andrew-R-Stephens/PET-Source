package com.tritiumgaming.phasmophobiaevidencepicker.presentation.ui.activities.operation.utilities.codex.children.itemstore.fragments.children
...
import com.tritiumgaming.phasmophobiaevidencepicker.presentation.ui.activities.operation.utilities.codex.children.itemstore.fragments.ItemStoreFragment
...
class EquipmentFragment : ItemStoreFragment() {
    ...
    override fun buildStoreData() {
        investigationViewModel.equipmentStoreModel.groups.forEach {
            Log.d("ItemStore", "Adding group to Fragment ${getString(it.nameData)} ${it.itemImages.size}")
            storeData.addGroup(it)
        }
    }
