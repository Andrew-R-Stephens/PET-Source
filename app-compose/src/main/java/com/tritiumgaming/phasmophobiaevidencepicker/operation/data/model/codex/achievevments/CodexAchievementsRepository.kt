...
import com.tritiumgaming.phasmophobiaevidencepicker.operation.data.model.codex.achievevments.CodexAchievementsRepository.CodexAchievementGroup.CodexAchievementItem

class CodexAchievementsRepository(context: Context) : CodexGroups() {
