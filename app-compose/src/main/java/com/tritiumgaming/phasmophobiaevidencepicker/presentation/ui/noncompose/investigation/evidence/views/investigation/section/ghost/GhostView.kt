package com.tritiumgaming.phasmophobiaevidencepicker.presentation.ui.noncompose.investigation.evidence.views.investigation.section.ghost
...
import com.tritiumgaming.phasmophobiaevidencepicker.domain.model.investigation.investigationmodels.GhostScoreModel
...
class GhostView : ConstraintLayout {
        ...
        if (iconRowLayout != null) {
            ...
            while (k < evidenceCount) {
                ...
                when (currentEvidence.ruling) {
                    POSITIVE -> evidenceIcon.setColorFilter(positiveSelColor)
                    NEGATIVE -> evidenceIcon.setColorFilter(negativeSelColor)
                    NEUTRAL -> evidenceIcon.setColorFilter(neutralSelColor)
                }
                k++
            }
    ...
    private fun getRulingColor(ruling: Ruling): Int {
        return when (ruling) {
            POSITIVE -> positiveSelColor
            NEGATIVE -> negativeSelColor
            NEUTRAL -> neutralSelColor
        }
    }
