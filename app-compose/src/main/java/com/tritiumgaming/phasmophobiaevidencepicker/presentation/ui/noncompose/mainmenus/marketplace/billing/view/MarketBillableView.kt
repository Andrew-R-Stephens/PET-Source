package com.tritiumgaming.phasmophobiaevidencepicker.presentation.ui.noncompose.mainmenus.marketplace.billing.view
...
import com.tritiumgaming.phasmophobiaevidencepicker.util.ColorUtils.interpolate

@Deprecated("Migrate to Jetpack Compose")
class MarketBillableView : MaterialCardView {

    private var billableItem: MicroTransactionEntity? = null
    ...
    fun setBillableItem(billableItem: MicroTransactionEntity?) {
    ...
    fun getBillableItem(): MicroTransactionEntity? {
        return billableItem
    }
}
