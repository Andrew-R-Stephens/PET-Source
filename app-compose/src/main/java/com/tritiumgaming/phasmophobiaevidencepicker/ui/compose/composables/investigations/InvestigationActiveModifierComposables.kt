package com.tritiumgaming.phasmophobiaevidencepicker.ui.compose.composables.investigations
...
fun ActiveModifierDetails(
    ...
    Box(
        ...
        Column(
            ...
            investigationViewModel?.let {
                it.timerModel?.let { timer ->
                    PhaseModifierDetails(timer) }
                MapModifierDetails(it.mapCarouselModel)
                DifficultyModifierDetails(it.difficultyCarouselModel)
                it.investigationModel.ghostRepository.let { repository ->
                    ActiveGhostModifierDetails(repository)
                }
            }
        }
    }
