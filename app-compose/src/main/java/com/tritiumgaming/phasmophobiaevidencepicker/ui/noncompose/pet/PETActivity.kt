...
abstract class PETActivity : AppCompatActivity() {
    ...
    protected lateinit var globalPreferencesViewModel: com.tritiumgaming.phasmophobiaevidencepicker.data.viewmodel.GlobalPreferencesViewModel
    ...
    private fun initGlobalPreferencesViewModel() {
        globalPreferencesViewModel = ViewModelProvider(
            this,
            com.tritiumgaming.phasmophobiaevidencepicker.data.viewmodel.GlobalPreferencesViewModel.GlobalPreferencesFactory(
        ...
        )[com.tritiumgaming.phasmophobiaevidencepicker.data.viewmodel.GlobalPreferencesViewModel::class.java]
