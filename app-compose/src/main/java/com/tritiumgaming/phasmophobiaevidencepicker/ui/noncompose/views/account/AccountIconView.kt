...
class AccountIconView : MaterialCardView {
    ...
    private fun setDefaults() {
        ...
        profileIcon.setContent { AccountIcon(com.tritiumgaming.phasmophobiaevidencepicker.data.firebase.firestore.transactions.user.FirestoreUser.currentFirebaseUser) }
