package com.tritiumgaming.phasmophobiaevidencepicker.ui.compose.investigation.evidence.views.popups
    ...
    fun build(
        ...
        label_cost.text = Html.fromHtml(
            replaceHTMLFontColor(
                "${ context.getString(R.string.evidence_requirement_cost_title) } ${ evidenceRecord.getCost(context) }",
