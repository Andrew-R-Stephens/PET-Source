...
import com.tritiumgaming.phasmophobiaevidencepicker.domain.model.startscreen.graphicsdata.AnimatedFrostModel
import com.tritiumgaming.phasmophobiaevidencepicker.domain.model.startscreen.graphicsdata.AnimatedHandModel
import com.tritiumgaming.phasmophobiaevidencepicker.domain.model.startscreen.graphicsdata.AnimatedMirrorModel
import com.tritiumgaming.phasmophobiaevidencepicker.domain.model.startscreen.graphicsdata.AnimatedOrbModel
import com.tritiumgaming.phasmophobiaevidencepicker.domain.model.startscreen.graphicsdata.AnimatedWritingModel
...
class AnimationModel {
    ...
    private var queue: AnimatedQueueModel =
        AnimatedQueueModel(
            10,
            500
        )
        ...
        for (i in 0 until HAND_COUNT) {
            if (BitmapUtils.bitmapExists(bitmapHand)) {
                bitmapHand?.let { bitmapHand ->
                    ...
                    val data =
                        com.tritiumgaming.phasmophobiaevidencepicker.domain.model.startscreen.graphicsdata.AnimatedHandModel(
                            screenW,
                            screenH,
                            bW,
                            bH
        ...
        if (queue.canDequeue() && (currentPoolSize < maxQueue)) {
            ...
            lastAnimInList?.let {
                when(lastAnimInList) {
                    ...
                    is com.tritiumgaming.phasmophobiaevidencepicker.domain.model.startscreen.graphicsdata.AnimatedHandModel -> {
                        if (BitmapUtils.bitmapExists(bitmapHand)) {
                            bitmapHand?.let { bitmapHand ->
                                var bitmapW = 0
                                var bitmapH = 0
                                ...
                                bitmapHandRot =
                                    (lastFromCurrentPool as com.tritiumgaming.phasmophobiaevidencepicker.domain.model.startscreen.graphicsdata.AnimatedHandModel)
        ...
        try { currentPool.forEach { a ->
            ...
            try {
                when(a) {
                    ...
                    is com.tritiumgaming.phasmophobiaevidencepicker.domain.model.startscreen.graphicsdata.AnimatedHandModel -> a.draw(canvas, paint, bitmapHandRot)
