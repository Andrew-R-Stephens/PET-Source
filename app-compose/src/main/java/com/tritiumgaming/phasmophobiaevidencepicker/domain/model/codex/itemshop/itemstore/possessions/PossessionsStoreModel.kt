...
class PossessionsStoreModel(): ItemStoreListModel() {
    ...
    fun init(context: Context){
        ...
        val shopListTypedArray = context.resources.obtainTypedArray(R.array.shop_cursedpossessions_array)
        ...
        for (i in 0 until shopListTypedArray.length()) {
            ...
            val attributesTypedArray =
                context.resources.obtainTypedArray(shopTypedArray.getResourceId(attributesTextKey, 0))
