package com.tritiumgaming.phasmophobiaevidencepicker.activities.compose.investigation.evidence.views.popups
...
import com.tritiumgaming.phasmophobiaevidencepicker.utils.JavaColor
import com.tritiumgaming.phasmophobiaevidencepicker.utils.TextCase
import com.tritiumgaming.phasmophobiaevidencepicker.views.composables.AutoResizedStyleType
...
fun RowScope.PrimaryPageButton(
    ...
    var rememberActivePage by remember { activePage }
    ...
    Button(
        ...
        AutoResizedText(
            ...
            font = LocalTypography.current.secondary.regular,
