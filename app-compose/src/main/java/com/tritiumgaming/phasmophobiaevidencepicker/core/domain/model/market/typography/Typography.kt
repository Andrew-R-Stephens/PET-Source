package com.tritiumgaming.phasmophobiaevidencepicker.core.domain.model.market.typography

import com.tritiumgaming.phasmophobiaevidencepicker.core.presentation.ui.theme.types.ExtendedTypography

data class Typography (
    val marketTypographyEntity: TypographyEntity? = null,
    private val uuid: String = marketTypographyEntity?.uuid ?: "",
    val typography: ExtendedTypography
) {
    fun getAsPair(): Pair<String, Typography> {
