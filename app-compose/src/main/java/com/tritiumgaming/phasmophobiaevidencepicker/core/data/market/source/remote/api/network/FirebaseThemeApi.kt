package com.tritiumgaming.phasmophobiaevidencepicker.core.data.market.source.remote.api.network

import android.util.Log
import com.google.firebase.firestore.DocumentReference
import com.google.firebase.firestore.DocumentSnapshot
import com.google.firebase.firestore.FirebaseFirestoreException
import com.tritiumgaming.phasmophobiaevidencepicker.core.data.market.source.remote.api.firestore.transactions.store.merchandise.bundles.FirestoreMerchandiseBundle.Companion.getAllBundles
import com.tritiumgaming.phasmophobiaevidencepicker.core.data.market.source.remote.api.firestore.transactions.store.merchandise.palettes.FirestoreMerchandisePalettes.Companion.getAllThemes
...
class StoreThemesApi: ThemeApi {
    ...
    override suspend fun fetchAllPalettes(): List<PaletteEntity> {

        val themesList = mutableListOf<PaletteEntity>()
    ...
    override suspend fun fetchAllTypographies(): List<TypographyEntity> {

        val typographiesList = mutableListOf<TypographyEntity>()
