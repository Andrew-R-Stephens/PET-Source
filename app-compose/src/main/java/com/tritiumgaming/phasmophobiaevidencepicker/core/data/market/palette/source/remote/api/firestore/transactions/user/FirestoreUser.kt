package com.tritiumgaming.phasmophobiaevidencepicker.core.data.market.palette.source.remote.api.firestore.transactions.user
...
import com.tritiumgaming.phasmophobiaevidencepicker.core.data.market.palette.source.remote.api.firestore.transactions.user.account.FirestoreAccount
    ...
    companion object {
        ...
        val userDocument: DocumentReference
            @Throws(Exception::class) get() {
                ...
                val userCollection = db.collection(FirestoreUser.Companion.COLLECTION_USERS)
