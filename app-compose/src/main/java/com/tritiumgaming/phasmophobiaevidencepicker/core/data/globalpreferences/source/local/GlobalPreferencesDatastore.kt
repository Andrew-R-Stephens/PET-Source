...
import com.tritiumgaming.phasmophobiaevidencepicker.core.domain.repository.source.datastore.GlobalPreferencesDatastore
import com.tritiumgaming.phasmophobiaevidencepicker.core.domain.repository.source.datastore.GlobalPreferencesDatastore.Companion.KEY_ALLOW_CELLULAR_DATA
import com.tritiumgaming.phasmophobiaevidencepicker.core.domain.repository.source.datastore.GlobalPreferencesDatastore.Companion.KEY_ALLOW_HUNT_WARN_AUDIO
import com.tritiumgaming.phasmophobiaevidencepicker.core.domain.repository.source.datastore.GlobalPreferencesDatastore.Companion.KEY_ALLOW_INTRODUCTION
import com.tritiumgaming.phasmophobiaevidencepicker.core.domain.repository.source.datastore.GlobalPreferencesDatastore.Companion.KEY_DISABLE_SCREENSAVER
import com.tritiumgaming.phasmophobiaevidencepicker.core.domain.repository.source.datastore.GlobalPreferencesDatastore.Companion.KEY_ENABLE_GHOST_REORDER
import com.tritiumgaming.phasmophobiaevidencepicker.core.domain.repository.source.datastore.GlobalPreferencesDatastore.Companion.KEY_ENABLE_RTL
import com.tritiumgaming.phasmophobiaevidencepicker.core.domain.repository.source.datastore.GlobalPreferencesDatastore.Companion.KEY_HUNT_WARN_MAX_TIMEOUT
import com.tritiumgaming.phasmophobiaevidencepicker.core.domain.repository.source.datastore.GlobalPreferencesDatastore.GlobalPreferences
