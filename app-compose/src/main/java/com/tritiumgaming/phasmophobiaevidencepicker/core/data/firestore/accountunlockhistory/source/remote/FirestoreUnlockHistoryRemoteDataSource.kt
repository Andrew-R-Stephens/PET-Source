package com.tritiumgaming.phasmophobiaevidencepicker.core.data.firestore.accountunlockhistory.source.remote

import android.util.Log
import com.google.firebase.Timestamp
import com.google.firebase.firestore.SetOptions
import com.tritiumgaming.phasmophobiaevidencepicker.core.data.firestore.accountunlockhistory.reference.FirestoreUnlockHistoryCollection.Companion.unlockHistoryCollection
import com.tritiumgaming.phasmophobiaevidencepicker.core.data.firestore.accountunlockhistory.reference.FirestoreUnlockHistoryDocument.Companion.FIELD_DATE_UNLOCKED
import com.tritiumgaming.phasmophobiaevidencepicker.core.data.firestore.accountunlockhistory.reference.FirestoreUnlockHistoryDocument.Companion.FIELD_TYPE
import com.tritiumgaming.phasmophobiaevidencepicker.core.data.market.merchandise.source.api.OnFirestoreProcessListener

class FirestoreUnlockHistoryRemoteDataSource {
