...
class FirestoreUnlockHistory {
    ...
    companion object {
        ...
        fun init() {
            com.tritiumgaming.phasmophobiaevidencepicker.data.remote.api.firestore.transactions.user.account.transactions.types.FirestoreUnlockHistory.Companion.unlockedDocument.get()
        ...
        private val unlockedDocument: DocumentReference
            @Throws(Exception::class) get() {
                ...
                return purchaseHistoryCollection.document(com.tritiumgaming.phasmophobiaevidencepicker.data.remote.api.firestore.transactions.user.account.transactions.types.FirestoreUnlockHistory.Companion.DOCUMENT_UNLOCKED_ITEM)
            }
