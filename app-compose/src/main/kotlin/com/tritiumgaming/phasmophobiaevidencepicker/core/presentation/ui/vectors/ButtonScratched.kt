...
private var _buttonScratched: ImageVector? = null

val ButtonScratched: ImageVector
    get() {
        if (_buttonScratched != null) {
            return _buttonScratched!!
        }
        _buttonScratched = Builder(
    ...
    private fun Preview() {
        Box(modifier = Modifier.padding(12.dp)) {
            Image(imageVector = ButtonScratched, contentDescription = null)
        }
    }
