...
private var _arrow60Left: ImageVector? = null

val Arrow60Left: ImageVector
    get() {
        if (_arrow60Left != null) {
            return _arrow60Left!!
        }
        _arrow60Left = Builder(
            name = "Arrow60Left", 
    ...
    private fun Preview() {
        Box(modifier = Modifier.padding(12.dp)) {
            Image(imageVector = Arrow60Left, contentDescription = null)
        }
    }
