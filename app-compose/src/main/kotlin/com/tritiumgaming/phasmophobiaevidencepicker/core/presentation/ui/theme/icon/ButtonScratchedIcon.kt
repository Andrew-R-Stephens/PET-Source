...
import com.tritiumgaming.phasmophobiaevidencepicker.core.presentation.ui.theme.icon.vectors.getButtonScratchedVector
...
fun ButtonScratchedIcon(
    ...
    Image(
        modifier = modifier,
        imageVector = getButtonScratchedVector(
            listOf(
