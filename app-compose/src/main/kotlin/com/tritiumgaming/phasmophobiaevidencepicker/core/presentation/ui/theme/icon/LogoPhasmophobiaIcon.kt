...
import com.tritiumgaming.phasmophobiaevidencepicker.core.presentation.ui.theme.icon.vectors.getLogoPhasmophobiaVector
...
@Composable
fun LogoPhasmophobiaIcon(
    modifier: Modifier = Modifier
) {

    Image(
        modifier = modifier,
        imageVector = getLogoPhasmophobiaVector(
            listOf(
